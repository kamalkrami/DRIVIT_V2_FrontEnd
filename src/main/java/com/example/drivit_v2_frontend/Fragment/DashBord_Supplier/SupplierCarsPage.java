...
public class SupplierCarsPage extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView  = inflater.inflate(R.layout.fragment_supplier_cars_page, container, false);
        ...
        recyclerView=rootView.findViewById(R.id.rv_supplier_car_page);
        ...
        String url = baseUrl + "/cars/id_supplier/" + _userID;
