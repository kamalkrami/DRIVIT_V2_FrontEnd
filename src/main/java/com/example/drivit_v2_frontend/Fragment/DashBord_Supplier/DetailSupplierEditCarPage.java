...
public class DetailSupplierEditCarPage extends AppCompatActivity {

    ImageView image_car;
    TextView car_name,car_detail,car_status;
    Button btn_goback,btn_edit;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_detail_edit_supplier_car_page);
        ...
        btn_edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(DetailSupplierEditCarPage.this, EditCarPage.class);
